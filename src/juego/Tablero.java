...
public class Tablero {
	...
	/**
	 * pre : el juego asociado terminó. post: muestra un mensaje indicando el
	 * resultado del juego.
	 */
	public void mostrarResultado() {
		...
		if (juego.hayGanador() && juego.obtenerGanador().equals("Mariano")) {
			...
			textoResultado = new Text(
					"Ganó Mariano, se puso contento y nos probó a todos."
			...
			textoResultado = new Text("Ganó el jugador "
